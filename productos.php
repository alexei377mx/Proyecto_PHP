                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <form class="form-inline my-2 my-lg-0" action="resultados_busqueda.php" method="GET">
                                <div class="input-group">
                                    <input class="form-control mr-sm-2" type="search" placeholder="Buscar calzado" aria-label="Buscar" name="search" style="width: 50%; background-color: transparent; border-color: rgba(129, 129, 129, 0.5)">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style=" background-color: rgba(0, 0, 0, 0.25); backdrop-filter: blur(5px);">
                                <a class="nav-link active" style="color: #9b9b9b;" href="nosotros.html">Nosotros</a>
                                <a class="nav-link" style="color: #9b9b9b;" href="identidad.html">Identidad</a>
                                <a class="nav-link" style="color: #9b9b9b;" href="contacto.html">Contacto</a>
                                <a class="nav-link" style="color: #9b9b9b;" href="legal.html">Legal</a>
                            </div>
