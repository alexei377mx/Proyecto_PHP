...
<body>
	...
	<div class="container fade-in" style="background-color: rgba(255, 255, 255, 0.05); margin-top: 100px; margin-bottom: 20px;">
		<h1 class="display-4" style="color: #ffffffce; text-align: center;">Bienvenido a Sneakersun SA de CV</h1>
		<p class="lead" style="color: #ffffffce;">Sneakersun SA de CV es una empresa dedicada a la venta de calzado. <br>
			...
			<br>
			Si estás buscando calzado cómodo, moderno y a la moda, Sneakersun es una excelente opción. 😊
		</p>
		<a href="acerca.php" class="btn btn-primary btn-lg" style="background-color: purple; color: #ffffffce; border: none;">Más sobre nosotros</a>
	</div>

	<!-- productos destacados (3) -->
	<div class="container fade-in" style="margin-top: 30px; background-color: rgba(255, 255, 255, 0.05);">
		<h1 style="color: #ffffffce; text-align: center;">Lo más destacado del mes</h1>
